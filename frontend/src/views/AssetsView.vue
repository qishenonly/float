...
<template>
  <div>
    ...
    <div v-if="showModal" class="fixed inset-0 bg-black/50 z-50 flex items-end sm:items-center justify-center sm:p-6" @click.self="closeModal">
      <div class="bg-white rounded-t-3xl sm:rounded-3xl w-full max-w-md p-6 space-y-5 animate-slide-up sm:animate-enter max-h-[85vh] overflow-y-auto mb-20 sm:mb-0">
